...
headerTemplateCommon();


// footer template

let footerTemplateCommon = () =>{
    let footerTemplate =`
    <div id="contact">
...
let checkLogin = () => {
    if (!isLogin || isLogin === 'false') {
        ...
        loginElement.dataset.target = '';
        loginElement.innerText = 'LOGOUT';
        let payNowElement = document.getElementById("pay-now-btn");
        payNowElement.disabled = false;
    }
}
